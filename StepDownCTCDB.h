...
class StepDownCTCDB : public Basic
{
public:
	StepDownCTCDB(int kiFlag, int koFlag, int CTFlag, double *sval, double *bval, double *xval, double *kihval, double *kohval, double *CThval, double *Cpn,
