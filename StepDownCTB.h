...
class StepDownCTB : public Basic
{
public:
	StepDownCTB(int kiFlag, int koFlag, int CTFlag, double *sval, double *bval, double *xval, double *kihval, double *kohval, double *CThval, double *Cpn,
...
private:	
	...
	double fd_price0(double *greeks);
	double fd_price1(double *greeks);
