...
VBStepDownCDA::VBStepDownCDA(int kiFlag, double sval, double bval, double *xval, double *kihval, 
	      double *Cpn,
...
{		
	...
	if(debugFlag) {
		...
		ofstream logs;
		logs.open("c:/logland/vbstepdowncdainput.txt",ios::out);
...
double VBStepDownCDA::getVega(int vegaN, int *vegaidx) {
...
double VBStepDownCDA::getRho(int rhoN,int *rhoidx) {
...
double VBStepDownCDA::cf_price()
{	
	return 7777;
}

double VBStepDownCDA::fd_price(double *greeks)
{
...
void VBStepDownCDA::curttimeVol(double *vol, int day)
{
	int i;
