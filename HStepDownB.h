...
class HStepDownB : public Basic
{
public:
	HStepDownB(int kiFlag, int koFlag, int ki1Flag, int ki2Flag, double *sval, double *bval, double *xval, double *kihval, double *kohval, double *Cpn,
