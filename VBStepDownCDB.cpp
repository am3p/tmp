#include "VBStepDownCDB.h"
#include <iostream>
#include <fstream>

 

VBStepDownCDB::VBStepDownCDB(int kiFlag, double *sval, double *bval, double *xval, double *kihval, double *Cpn,
...
double VBStepDownCDB::getVega(int vegaN, int *vegaidx) {
...
double VBStepDownCDB::getRho(int rhoN,int *rhoidx) {
...
double VBStepDownCDB::getCorrDelta(int corrdeltaN,int *corrdeltaidx) {
...
double VBStepDownCDB::cf_price()
{	
	return 7777;
}

double VBStepDownCDB::fd_price(double *greeks)
{
...
void VBStepDownCDB::curttimeVol1(double *vol, int day)
{
	int i;
...
void VBStepDownCDB::curttimeVol2(double *vol, int day)
{
	int i;
...
double VBStepDownCDB::curttimeCorr(int day)
{
	int i;		
	int findidx;
...
int VBStepDownCDB::findinteridx(double x, double *Dx, int DxN)
{
	int i;		
	int findidx;
