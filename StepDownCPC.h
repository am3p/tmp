...
class StepDownCPC : public Basic
{
public:
	StepDownCPC(int kiFlag, int koFlag, double *sval, double *bval, double *xval, double *kihval, double *kohval, double *Cpn,
...
private:	
	...
	//pay
	int m_paymatuN;
	double **m_payxval; //[AsNUM3][m_paymatuN]
	double *m_payCpn;
	int *m_paymatu;
	...
	double m_sval[AsNUM3]; // 현재가
 
	double m_bval[AsNUM3]; // 기준가
	...
	int m_FXvoltype; // 볼 type 0:상수, 1;atm term vol, 2: local 
