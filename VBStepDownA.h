...
class VBStepDownA : public Basic
{
public:
	VBStepDownA(int kiFlag, double sval, double bval, double *xval, double *kihval, double *Cpn,
...
private:
	...
	double m_shiftHRate;
	double m_spreadHRate;   // 만기만
	double *m_spreadXRate;
	double m_spreadHS;  // 만기만
	//double *m_spreadXS;
