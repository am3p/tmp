...
TomA::TomA(double sval, double stom, double btom, int STDayN, int *STStartDay, double *IXT, double *IndexT, int *STEndDay, double *IXTheta,
...
double TomA::getBatch(double tsval) {
...
double TomA::getDeltaGammaTheta() {
...
double TomA::getVega(int vegaN, int *vegaidx) {
...
double TomA::getRho(int rhoN,int *rhoidx) {
...
void TomA::curttimeVol(double *vol, int day, int Asidx)
{
	int i;
...
/*
double TomA::curttimeFXCorr2(int day)
{
	int i;		
	int findidx;
...
int TomA::findinteridx(double x, double *Dx, int DxN)
{
	int i;		
	int findidx;
