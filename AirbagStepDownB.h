...
class AirbagStepDownB : public Basic
{
public:
	AirbagStepDownB(int kiFlag, int koFlag, double *sval, double *bval, double *xval, double *kihval, double *kohval, double *airbagxval, double *Cpn,
